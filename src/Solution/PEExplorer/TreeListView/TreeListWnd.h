...
// Konstanden f? Farben (TVM_SETBKCOLOR)
...
// Konstanden f? GetNextItem (TVM_GETNEXTITEM)
#define 	TVGN_DROPHILITESUB		0x000C				// Ausgew?lte Spalte holen
#define 	TVGN_CARETSUB			0x000D				// Drophighilite Spalte holen
#ifndef		TVGN_NEXTSELECTED
#define 	TVGN_NEXTSELECTED		0x000E				// N?hster ausgew?lter Eintrag
#endif 	
#define 	TVGN_FOCUS				0x000F				// Eintrag der den Focus hat
#define 	TVGN_FOCUSSUB			0x0010				// Spalte  die den Focus hat
#define 	TVGN_NEXTSELCHILD		0x0011				// N?hster ausgew?lter Kindeintrag


// Konstanden f? InsertColumn (mask)
...
#define 	TVS_EX_SUBSELECT		0x00040000			// Sub-Eitr?e seperat ausw?len
...
#endif 	
#define		TVS_EX_SEND_HOVER		0x00100000  // TVS_NOSCROLL overrides this


// Konstanden f? neue Nachrichten
#define 	TVM_GETHEADER			(TV_FIRST+100-1)
#define 	TVM_GETCOLUMNCOUNT		(TV_FIRST+100-2)
#define 	TVM_DELETECOLUMN		(TV_FIRST+100-3)
#define 	TVM_INSERTCOLUMN		(TV_FIRST+100-4)
#define 	TVM_SELECTSUBITEM		(TV_FIRST+100-5)
#define 	TVM_SELECTDROP			(TV_FIRST+100-6)
#define 	TVM_SETITEMBKCOLOR		(TV_FIRST+100-7)
#define 	TVM_GETITEMBKCOLOR		(TV_FIRST+100-8)
#define 	TVM_SETITEMTEXTCOLOR	(TV_FIRST+100-9)
#define 	TVM_GETITEMTEXTCOLOR	(TV_FIRST+100-10)
#define 	TVM_GETITEMOFROW		(TV_FIRST+100-11)
#define 	TVM_GETROWOFITEM		(TV_FIRST+100-12)	
#define 	TVM_SETCOLUMN			(TV_FIRST+100-13)
#define 	TVM_GETCOLUMN			(TV_FIRST+100-14)
#define 	TVM_SETCOLUMNWIDTH		(TV_FIRST+100-15)
#define 	TVM_GETCOLUMNWIDTH		(TV_FIRST+100-16)
#define 	TVM_SETUSERDATASIZE		(TV_FIRST+100-17)
#define 	TVM_GETUSERDATASIZE		(TV_FIRST+100-18)
#define 	TVM_GETUSERDATA			(TV_FIRST+100-19)
...
#define	MYGWL_USERDATA	GWLP_USERDATA
#else
#define MYGWL_WNDPROC	GWL_WNDPROC
#define	MYGWL_USERDATA	GWL_USERDATA
#endif
