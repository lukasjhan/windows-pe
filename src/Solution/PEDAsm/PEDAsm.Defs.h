...
#define ISC_INTEGER	 1		// General Integer set
#define ISC_FPU		 2		// 387 FPU set.
#define ISC_P6		 3		// P6 set
#define ISC_MMX		 4		// MMX set.
#define ISC_SSE		 5		// SSE set.
#define ISC_SSE2	 6		// SSE2 set.
#define ISC_SSE3	 7		// SSE3 set.
#define ISC_SSSE3	 8		// SSSE3 set.
#define ISC_SSE4_1	 9		// SSE4.1 set
#define ISC_SSE4_2	 10		// SSE4.2 set.
#define ISC_SSE4_A	 11		// AMD's SSE4.A set.
#define ISC_3DNOW	 12		// 3DNow! set.
#define ISC_3DNOWEXT 13		// 3DNow! Extensions set.
#define ISC_VMX		 14		// VMX (Intel) set.
#define ISC_SVM		 15		// SVM (AMD) set.
#define ISC_AVX		 16		// AVX (Intel) set.
#define ISC_FMA		 17		// FMA (Intel) set.
#define ISC_AES		 18		// AES/AVX (Intel) set.
#define ISC_CLMUL	 19		// CLMUL (Intel) set.
#define	ISC_AVX2	 20		// 
#define	ISC_BMI		 21		// 
