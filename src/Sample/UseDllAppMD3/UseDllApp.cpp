...
#include "../BasicDllMD3/BasicDll.h" 
#ifdef _WIN64
#	ifdef _DEBUG 
#		pragma comment(lib, "../0.bin/x64/Debug/BasicDllMD3.lib")
#	else
#		pragma comment(lib, "../0.bin/x64/Release/BasicDllMD3.lib")
#	endif
#else
#	ifdef _DEBUG 
#		pragma comment(lib, "../0.bin/x86/Debug/BasicDllMD3.lib")
#	else
#		pragma comment(lib, "../0.bin/x86/Release/BasicDllMD3.lib")
#	endif
#endif
