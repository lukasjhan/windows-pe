...
#include "../BasicDllMD/BasicDll.h" 
#ifdef _WIN64
#	ifdef _DEBUG 
#		pragma comment(lib, "../0.bin/x64/Debug/BasicDllMD.lib")
#	else
#		pragma comment(lib, "../0.bin/x64/Release/BasicDllMD.lib")
#	endif
#else
#	ifdef _DEBUG 
#		pragma comment(lib, "../0.bin/x86/Debug/BasicDllMD.lib")
#	else
#		pragma comment(lib, "../0.bin/x86/Release/BasicDllMD.lib")
#	endif
#endif
