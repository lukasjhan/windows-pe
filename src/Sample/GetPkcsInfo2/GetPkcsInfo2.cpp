...
int _tmain(int argc, TCHAR *argv[])
{
	...
	try
	{
		hImgFile = CreateFile(argv[1], GENERIC_READ, FILE_SHARE_READ,
		...
		LPWIN_CERTIFICATE pCert = (LPWIN_CERTIFICATE)(pImgView + pdd->VirtualAddress);
		CERT_BLOB cb;
		cb.cbData = pCert->dwLength - 8;
		cb.pbData = pCert->bCertificate;
